function shearfield_deviate, NEW_SHEARS, LENSMODEL_NOW=LENSMODEL_NOW,$
...
sqrt_w[*]=sqrt(weights[ipair,jpair])


; The deviate part for the flexion information
dev1=(flex_shear_diff - new_shear_diff)*sqrt_w

; Add in the part which keeps the shears near zero.
sig_g=0.3d
reg_scale=1d ; This could be 

dev2=reg_scale*mean(new_shears)/sig_g
